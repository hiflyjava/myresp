...
/**
 * @Auther: admin
 * @Date: 2019/7/16 09:53
 * @Description:
 */
public class MyExecelUtils {
    ...
    //构造方法，传入要导出的数据
    public MyExecelUtils(String title,String[] rowName,List<Object[]>  dataList){
    ...
    public void export(HttpServletResponse response) throws Exception{
        ...
        try{
            ...
            for(int n=0;n<columnNum;n++){
                ...
                cellRowName.setCellValue(1);                //设置列头单元格的数据类型
